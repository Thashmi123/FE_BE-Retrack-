...
export const authRoutes = [
  ...
  {
    path: "pages/authentication/login-bg-img/:layout",
    Component: <LoginTwo />,
  },
  {
    path: "pages/authentication/login-validation/:layout",
    Component: <LoginValidation />,
  },
  {
    path: "pages/authentication/login-tooltip/:layout",
  ...
  {
    path: "pages/authentication/register-bg-img/:layout",
    Component: <RegisterBgImg />,
  },
  {
    path: "pages/authentication/register-video/:layout",
    Component: <RegisterVideo />,
  },
  {
    path: "pages/authentication/unlock-user/:layout",
  ...
  {
    path: "pages/authentication/maintenance/:layout",
  ...
  {
    path: "pages/comingsoon/coming-bg-img/:layout",
    Component: <ComingBgImg />,
  },
  {
    path: "pages/comingsoon/coming-bg-video/:layout",
