...
const ChatHeader = () => {
  const { selectedUserr, currentUserr, setMenuToggle, menuToggle } = useContext(ChatAppContext);
  ...
  const userName = loggedInUser ?
    loggedInUser.name || loggedInUser.username || loggedInUser.Name || 'Current User' :
    'Guest User';
  ...
  const displayUserId = currentUserId || loggedInUser?.id || loggedInUser?.userId || 'Unknown';
      ...
      <div className='chat-header clearfix d-flex align-items-center'>
        <div className="d-flex align-items-center flex-grow-1">
          ...
          <div className="d-flex align-items-center me-4">
            ...
            <div className='about'>
              <div className='name text-primary fw-semibold' style={{ fontSize: '14px' }}>
                {userName}
              </div>
              <div className='status digits text-success' style={{ fontSize: '12px' }}>
            ...
            <>
              ...
              <div className='about'>
                ...
                <div className='status digits'>
                  <span className={`badge ${conversationInfo.status === 'Online' ? 'bg-success' : 'bg-secondary'}`}>
