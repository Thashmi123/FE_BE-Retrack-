...
// @Summary      DownloadAttendance 
// @Description   This API performs the DOWNLOAD operation on Attendance. It allows you to  Attendance records.
// @Tags          Attendance
// @Accept       json
// @Produce      json
...
// @Router      /DownloadAttendance [DOWNLOAD]

    func DownloadAttendanceApi(c *fiber.Ctx) error {


    _, objects, err := dao.DB_FindallAttendance ("1", "10", "", true)
	if err != nil {
		return err
	}
	...
	fileName := "Attendances" + time.Now().Format("2006-01-02") + ".csv"
