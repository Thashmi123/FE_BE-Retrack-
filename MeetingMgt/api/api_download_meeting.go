...
// @Summary      DownloadMeeting 
// @Description   This API performs the DOWNLOAD operation on Meeting. It allows you to  Meeting records.
// @Tags          Meeting
// @Accept       json
// @Produce      json
...
// @Router      /DownloadMeeting [DOWNLOAD]

    func DownloadMeetingApi(c *fiber.Ctx) error {


    _, objects, err := dao.DB_FindallMeeting ("1", "10", "", true)
	if err != nil {
		return err
	}
	...
	fileName := "Meetings" + time.Now().Format("2006-01-02") + ".csv"
