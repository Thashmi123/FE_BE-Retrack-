...
func DB_FindallMeeting(page, size, searchTerm string, noPagination bool) (int64, *[]dto.Meeting, error) {
	var skip int64 = 0
	var limit int64 = 0
	...
	cursor, err := dbConfig.DATABASE.Collection("Meetings").Aggregate(ctx, pipeline)
	if err != nil {
		return 0, nil, err
	}
